  ...
  <section class="py-5" id="features">
	<div class="container px-5 my-5" align="center">
        ...
        <p class="lead" ><a href="${path}/host/profile/${sessionScope.h_userid}">프로필</a></p>
    	  ...
    	  <p class="lead" ><a href="${path}/host/rooms_Confirm/${sessionScope.h_userid}"><b style="font-weight: 700;">숙소승인현황</b></a></p>
    	  ...
    	  <p class="lead" ><a>매출현황</a></p>
 	      <p class="lead" ><a href="${path}/host/delete.do">회원 탈퇴</a></p>
            ...
            <div align="right">
            <c:if test="${row.admin_confirm == '승인대기'}">
            ...
            <c:if test="${row.admin_confirm == '승인거절'}">
            <b style="font-size: 10px; color: red;">${row.admin_confirm}</b>
            </c:if>
            <c:if test="${row.admin_confirm == '삭제요청'}">
            <b style="font-size: 10px; color: red;">${row.admin_confirm}</b>
            </c:if>
            </span>
            </div>
