	  ...
	  <div class="row">
	    ...
	    <c:if test="${map.dto.h_profile_img==null}">
	      ...
	      <div class="col-md-8" align="center">
	        ...
	        <h4>
			<fmt:formatDate value="${map.today}" type="Date" pattern="yyyy-MM-dd"/> ~ 
			<fmt:formatDate value="${map.week}" type="Date" pattern="yyyy-MM-dd"/> 
	        </h4>
	        <br>
	               주간합계: <fmt:formatNumber type="number" maxFractionDigits="3" value="${map.weeklySum}" /> 원
