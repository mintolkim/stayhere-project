			...
			$(list).each(function(){
				...
				if(checkImageType(this)){ //이미지 파일
					str="<div><a href='${path}/qna/displayFile?fileName="
						+getImageLink(this)+"'>";
					str+="<img src='${path}/qna/displayFile?fileName="
						+this+"' style='width:70px;height:70px;'></a>";	
				}else{//이미지가 아닌 경우
					str="<div>";
					str+="<a href='${path}/qna/displayFile?fileName="
...
<body>
 <%@ include file="../include/navbar.jsp"%>
  ...
  <div class="container px-4 px-lg-5 mt-5">
   ...
   <h2 class="fw-light " style="font-size: 18px; margin-top: 20px;">Q&A 글수정 게시판입니다</h2></div>
    <!-- 게시판 글쓰기 -->
    <form id="form1" name="form1" action="${path }/qna/update.do" method="post">
    <table id="write" style="width:100%;">
     <tr>
     <th>제목</th>
     <td>
     <input type="text" id="subject" name="subject" value="${dto.subject }" style="width:100%;"></td>
     </tr>
     <tr>
     <th>카테고리</th>
     ...
     <tr>
     <td colspan="2">
       <textarea class="form-control" rows="20" id="ckeditor" name="contents">${dto.contents }</textarea>
       <script>
     ...
     <button type="button"  id="btnEdit" style="display:inline-block;font-weight: bold;" 
				class="btn btn-warning">수정하기</button>
	<button type="button"  id="btnDelete" style="display:inline-block;font-weight: bold;" 
