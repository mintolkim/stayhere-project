			...
			<div class="default_width container-fluid mx-5" align="center">
				<div class="row" align="center">
					...
					<div class="list-group col-sm-2 mt-4 mx-2 px-2" id="profile-tab">
						...
						<br> <a
							href="${path}/guest/guest_view/${sessionScope.userid}"
							class="list-group-item list-group-item-action">프로필</a> <a
							href="${path}/reservations/list/guest"
							class="list-group-item list-group-item-action">예약내역</a> <a
							href="${path}/reviews/reviewUserList/${sessionScope.userid}" class="list-group-item list-group-item-action">내가
							작성한 리뷰</a> <a href="#" class="list-group-item list-group-item-action">관심스테이</a>
					</div>


					<div class="col-sm-8 mt-2 mx-2 mb-2" align="center">
						<p
							style="text-align: center; font-size: 26px; font-weight: bold; letter-spacing: 10px;">Reservation
							status</p>
						<br>
						<ul class="nav nav-tabs nav-justified" id="tab-bar">
							<li class="nav-item"><a class="nav-link active"
								data-bs-toggle="tab" href="#status_1">예약완료</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#status_2">예약취소</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#status_3">이용완료</a></li>
						</ul>
						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="status_1">
								<c:forEach var="res" items="${resList}">
									<c:if test="${res.res_idx != null && res.res_state == '예약요청'}">
										<div
											class="row gx-4 gx-lg-5 align-items-center my-5 mx-1 border border-1"
											...
											<div class="col-lg-6 col-sm-6 py-2"
												...
												<hr class="gray_line">
												<i class="bi bi-geo-alt-fill"></i>&nbsp;<span>${res.city}
													${res.country}</span><br> <span>${res.checkin_date} ~
													${res.checkout_date}</span><br>
												<hr class="gray_line">
												<span class="fs-5">￦<fmt:formatNumber
														value="${res.total_price}" pattern="#,###,###" /></span><br>
												<span><fmt:formatDate value="${res.res_date}"
														pattern="yyyy.MM.dd hh:mm" /></span><br>
												<br>
												<button class="btn btn-warning btn-lg"
													onclick="reserveDetail(${res.res_idx})"
													style="color: white; font-size: 16px;">예약 정보</button>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<button class="btn btn-danger btn-lg"
													onclick="cancel('${res.res_idx}')" style="font-size: 16px;">예약
													취소</button>
											</div>
										</div>
									</c:if>
										...
										<div
											...
											<div class="col-lg-6 col-sm-6" style="text-align: center;">
												...
												<i class="bi bi-geo-alt-fill"></i>&nbsp;<span>${res.city}
													...
													${res.checkout_date}</span><br>
												<hr class="gray_line">
												<span class="fs-4">￦<fmt:formatNumber
														value="${res.total_price}" pattern="#,###,###" /></span><br>
												<span><fmt:formatDate value="${res.res_date}"
														pattern="yyyy.MM.dd hh:mm" /></span><br>
												<br>
							...
							<div class="tab-pane fade" id="status_3">
								<c:forEach var="res" items="${resList}">
									<c:if
										test="${res.res_idx != null && res.res_state == '예약완료' || res.res_state == '입실완료' || res.res_state == '이용완료'}">
										<div
											class="row gx-4 gx-lg-5 align-items-center my-5 mx-1 border border-1"
											style="border-color: #f2f2f2;">
											<div class="col-lg-6 col-sm-6 py-2">
											...
											<div class="col-lg-6 col-sm-6" style="text-align: center;">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												<button class="btn btn-warning btn-lg"
													onclick="review('${res.room_idx}')"
													style="color: white; font-size: 16px;">후기작성</button>
											</div>
										</div>
									</c:if>
								</c:forEach>
							...
							<c:choose>
								...
								<c:otherwise>
									<button type="button" onclick="review('${res.room_idx}')"
										class="reserveMember_room_btn default_btn medium_text rounded">후기
										작성</button>
								</c:otherwise>
							</c:choose>
						</div>
