...
public interface RoomsService {
	public List<RoomsDTO> listMap(String cityname, RoomsDTO roomdto, int lower, int higher, String checkin_date, String checkout_date);//지도출력
	...
	public RoomsDTO getRoomInfo(int room_idx); //룸 사진과 정보
	public void deleteConfirm(int room_idx); //삭제요청
	public void updateRoom(RoomsDTO dto); //룸정보수정
	public void updateRoomphoto(RoomsDTO dto); //룸사진수정
